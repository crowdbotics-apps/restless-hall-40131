"""
Django settings for restless_hall_40131 project.
...
ROOT_URLCONF = 'restless_hall_40131.urls'
...
WSGI_APPLICATION = 'restless_hall_40131.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "restless_hall_40131 API",
    "DESCRIPTION": "API documentation for restless_hall_40131 App",
    "VERSION": "v1",
}
